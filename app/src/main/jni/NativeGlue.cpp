...
JNIEXPORT void JNICALL Java_se_anotherhermit_voxels_GLESView_resize(JNIEnv *env, jobject obj, jint width, jint height);
JNIEXPORT void JNICALL Java_se_anotherhermit_voxels_GLESView_step(JNIEnv *env, jobject obj);
JNIEXPORT void JNICALL Java_se_anotherhermit_voxels_GLESView_scroll(JNIEnv *env, jobject obj, jfloat dx, jfloat dy);
JNIEXPORT void JNICALL Java_se_anotherhermit_voxels_GLESView_scale(JNIEnv *env, jobject obj, jfloat scale);
JNIEXPORT void JNICALL Java_se_anotherhermit_voxels_GLESView_doubleTap(JNIEnv *env, jobject obj);
JNIEXPORT void JNICALL Java_se_anotherhermit_voxels_GLESView_longPress(JNIEnv *env, jobject obj);
};
